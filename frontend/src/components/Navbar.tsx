            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              {isAuthenticated ? (
                <div className="hidden lg:block relative group">
                  <button className="flex items-center space-x-2 p-2 text-slate-700 hover:text-slate-900 rounded-full hover:bg-slate-100 transition-colors duration-200">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                  ...
                  <Link
                    to="/signup"
                    className="bg-slate-800 text-white px-4 py-2 rounded-lg hover:bg-slate-900 transition-colors duration-200 font-medium"
                  >
                    Sign up
                  </Link>
                </div>
